...
class BalancepaymentController extends Controller
{
     public function chartindex(Request $request)
    {
        ...
        if($user_id != '') {
            ...
            // 選択された年度で予算が登録されている月を取得
            $month = Budget::where('register_year', $years)->where('user_id', Auth::id() )->pluck('register_month');
            
            // 選択された年度で登録されている予算を取得
            $stagebudgets = Budget::where('register_year',$years)->where('user_id', Auth::id() )->pluck('stage');
            $concertbudgets = Budget::where('register_year',$years)->where('user_id', Auth::id() )->pluck('concert');
            $webbudgets = Budget::where('register_year',$years)->where('user_id', Auth::id() )->pluck('web');
            $moviebudgets = Budget::where('register_year',$years)->where('user_id', Auth::id() )->pluck('movie');
            $cdbudgets = Budget::where('register_year',$years)->where('user_id', Auth::id() )->pluck('cd');
            $dvdbudgets = Budget::where('register_year',$years)->where('user_id', Auth::id() )->pluck('dvd');
            $magazinebudgets = Budget::where('register_year',$years)->where('user_id', Auth::id() )->pluck('magazine');
            $trainbudgets = Budget::where('register_year',$years)->where('user_id', Auth::id() )->pluck('train');
            $travelbudgets = Budget::where('register_year',$years)->where('user_id', Auth::id() )->pluck('travel');
            $toybudgets = Budget::where('register_year',$years)->where('user_id', Auth::id() )->pluck('toy');
            $othersbudgets = Budget::where('register_year',$years)->where('user_id', Auth::id() )->pluck('others');
            
            // 選択された年度より前で直近の予算を取得
            $beforemonth = Budget::where('register_year', '<', $years )->where('user_id', Auth::id() )->orderBy('id', 'desc')->first();
           
            $beforestagebudgets = Budget::where('register_year', '<', $years )->where('user_id', Auth::id() )->orderBy('id', 'desc')->pluck('stage')->first();
            $beforeconcertbudgets = Budget::where('register_year', '<', $years )->where('user_id', Auth::id() )->orderBy('id', 'desc')->pluck('concert')->first();
            $beforewebbudgets = Budget::where('register_year', '<', $years )->where('user_id', Auth::id() )->orderBy('id', 'desc')->pluck('web')->first();
            $beforemoviebudgets = Budget::where('register_year', '<', $years )->where('user_id', Auth::id() )->orderBy('id', 'desc')->pluck('movie')->first();
            $beforecdbudgets = Budget::where('register_year', '<', $years )->where('user_id', Auth::id() )->orderBy('id', 'desc')->pluck('cd')->first();
            $beforedvdbudgets = Budget::where('register_year', '<', $years )->where('user_id', Auth::id() )->orderBy('id', 'desc')->pluck('dvd')->first();
            $beforemagazinebudgets = Budget::where('register_year', '<', $years )->where('user_id', Auth::id() )->orderBy('id', 'desc')->pluck('magazine')->first();
            $beforetrainbudgets = Budget::where('register_year', '<', $years )->where('user_id', Auth::id() )->orderBy('id', 'desc')->pluck('train')->first();
            $beforetravelbudgets = Budget::where('register_year', '<', $years )->where('user_id', Auth::id() )->orderBy('id', 'desc')->pluck('travel')->first();
            $beforetoybudgets = Budget::where('register_year', '<', $years )->where('user_id', Auth::id() )->orderBy('id', 'desc')->pluck('toy')->first();
            $beforeothersbudgets = Budget::where('register_year', '<', $years )->where('user_id', Auth::id() )->orderBy('id', 'desc')->pluck('others')->first();
        }    
            // 各月の予算を格納する配列
            $years_budgets = [];
